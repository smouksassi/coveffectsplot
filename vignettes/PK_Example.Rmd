...
For this first step, we simulate without uncertainty and without BSV`zero_re()` at unique combination of covariates generated in the previous section. We then plot the results to visualize the effects. 
