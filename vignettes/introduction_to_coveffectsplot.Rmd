...
First we do a simple plot. Then we call `coveffectsplot::forest_plot`to make the final plot with the annotations, and legends. For interactice reordering and editing export the data as a "csv" and lauch the shiny app via `coveffectsplot::run_interactiveforestplot()`
