...
If the assumption of varying one covariate at a time does not hold we recommend the use of a relalistic distribution of correlated covariates (simualted or real). 
...
For simplicity, we will also assume that there were equal number of Sex = 1 (Man) and Sex = 0 (Woman) and that men and women had mean weights of 75 and 65 kg and the same standard deviation of 20 kg. 
...
CLBSVdistribution$paramname<- "CL"
  ...
  scale_x_continuous(breaks=c(0.25,0.61,0.82,1,1.22,1.63,2))+
  coord_cartesian(expand=FALSE,xlim = c(0.49,2.01))+
  ggplot2::labs(x="Individual Clearances with BSV/Reference CL",
