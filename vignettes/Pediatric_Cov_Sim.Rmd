...
idata <- tibble(
  ID = 1:nsubj,
  WT = c(rep(15.9,nsubj/2),rep(16.3,nsubj/2)),#from Nhanes at 6 years female and male
  AGE = 6,
...
## NCA parameters and associated ranges
...
## Simulation incorporating the multivariate realistic distribution
The section above generated 4900 Age/Weight/Sex distribution values that we will use for the simulation. We will remove the between subject variability to focus on the covariate effects. We show a plot of the normalized NCA parameters versus Weight and versus Age.
