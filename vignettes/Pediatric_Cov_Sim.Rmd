...
The section above generated 4900 Age/Weight/Sex distribution values that we will use for the simulation. We will remove the betwen subject variability to focus on the covariate effects. We show a plot of the normalized NCA parameters versus Weight and versus Age.
