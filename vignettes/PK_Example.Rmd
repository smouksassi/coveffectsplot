...
idata <- copy(covcomb)[, covname := NULL]
ev1 <- ev(time=0, amt=100, cmt=1)
...
ggplot(iter_sims, aes(x=time, y=CP, col=factor(WT), linetype=SEX)) +
...
covcomb[covname=="REF", covvalue := "85 kg Female 45 g/dL"]
covcomb
...
boxplotdat[, covvalue := factor(covvalue,
  levels=c("56 kg", "72 kg", "40 g/dL", "Male", "85 kg\nFemale\n45 g/dL", "98 kg", "128 kg", "50 g/dL"))]

ggplot(boxplotdat, aes(x=covvalue, y=paramvalue))+
  facet_grid(paramname2 ~ covname2, scales="free", labeller=label_parsed) +
  geom_boxplot() +
  labs(y="PK Parameter Values") +
