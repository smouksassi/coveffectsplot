...
```{r simcovariatemodelpkparam, collapse=TRUE, fig.height= 6 }
...
plot1<-    ggplot(nca.summaries %>% 
  ...
  facet_nested(paramname+ SEX~key, scales="free_x",switch = "both")+
  theme_bw(base_size = 18)+
  labs(x="",y="Standardized", fill ="Smoothed 90%\nquantreg intervals")+
...
# coveffectsdatacovrepbsv<- rbind(coveffectsdatacovrep,
