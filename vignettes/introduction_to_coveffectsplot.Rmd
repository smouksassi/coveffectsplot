...
dfbsv<- as.data.frame(
  round( quantile(CLBSVdistribution$CLBSV,probs=c(0,0.05,0.25,0.5,0.75,0.95,1)),2))
...
ggplot2::ggplot(data= CLBSVdistribution)+
 ggplot2:: geom_density(ggplot2::aes(x=CLBSV,
  ...
  ggplot2::labs(colour="",fill="BSV Ranges",x="Individual Clearances with BSV/Reference CL",
